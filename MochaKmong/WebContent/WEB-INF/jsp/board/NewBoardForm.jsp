...
<div class="comment-form">
                  <h4>공지 사항 작성</h4>
                  <form class="form-contact comment_form" action="newBoard.do" id="frm"name="frm"method="post">
                     <div class="row">
                        <div class="col-sm-2">
                        ...
                        <div class="col-sm-2">
                           <div class="form-group">
                              <input class="form-control"id="bBoard"name="bBoard"size="30" value="test" type="text" placeholder="대분류"readonly="readonly">
                           </div>
                        </div>
                        <div class="col-sm-3">
                           <div class="form-group">
