...
<head>
<meta charset="UTF-8">
<title>질문게시판 수정폼</title>
</head>
<body>
<div align="center">
	<br/><br/><br/>
	<div><h1>질문사항 수정</h1></div>
	<div>
		<form id="frm" name="frm"action="askEdit.do" method="post">
			<div>
				<table border="1">
					<tr>
						...
						<td width="100"><input type="text" id="bBoard"name="bBoard"size="20" value="${vo.bBoard }"required="required" readonly="readonly"></td>
